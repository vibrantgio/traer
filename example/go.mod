module github.com/vibrantgio/traer/gio
...
require (
	...
	github.com/vibrantgio/circle v0.0.1
...
require (
	...
	github.com/vibrantgio/font v0.0.1 // indirect
	github.com/vibrantgio/text v0.0.1 // indirect
